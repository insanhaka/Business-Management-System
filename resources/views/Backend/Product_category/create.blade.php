...
<div class="container-fluid" style="margin-top: 3%; margin-bottom: 6%;">
    ...
    <div class="card">
        <div class="card-header">
          <h2 class="text-primary">Add Product Category Data</h2>
        </div>
        <div class="card-body">
            <form method="POST" action="/dapur/product-category/create" enctype="multipart/form-data">
                {{ csrf_field() }}
                <div class="container" style="margin-top: -10px;">
                    ...
                    {{-- <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                <label for="exampleInput">Upload Category's Icon</label>
