...
<div class="container-fluid" style="margin-top: 3%; margin-bottom: 6%;">
    ...
    <div class="card">
        ...
        <div class="card-body">
            <form method="POST" action="/dapur/product/update/{!!$product->id!!}" enctype="multipart/form-data">
                {{ csrf_field() }}
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="number" class="form-control" id="stock" name="stock" placeholder="Stok" value="{!!$product->stock!!}">
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <select class="form-control" name="product_categories_id">
                                    ...
                                    <option value="{{ $item->id }}" {{ $item->id == $product->product_categories_id ? 'selected' : '' }}>{{ $item->name }}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
